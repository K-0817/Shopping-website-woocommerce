...
$col    = 1;
?>
    <h3>My delivery preferences</h3>
    <address class="input-wrapper">
        <label class="required" for="pickup_location">Pickup Location</label>
        <select name="pickup_location" id="pickup_location" class="select input" data-placeholder="Select Location">
            <?php
    ...
    <address class="input-wrapper">
        <label class="required" for="sales_agent">Pickup Location Service Agent</label>
        <select name="sales_agent" id="sales_agent" class="select input" data-placeholder="Select Agent">
            <?php
			...
			//var_dump(wp_count_posts('agent')->publish);
