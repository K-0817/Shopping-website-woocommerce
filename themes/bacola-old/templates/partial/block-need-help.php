<div class="categories__phone">
    ...
    <!-- <div class="categories__phone-tel dn" id="destenation-1-tl-js-get-phone-number-for-origin">Call Us on </div> -->
    <div class="categories__phone-info">WhatsApp Us </div>
    </div>
    <div class="categories__phone-right">

    <a class="categories__phone-btn tl-btn" id="destenation-2-tl-js-get-phone-number-for-origin" href="">
...
//     .innerHTML += " " + tl_linkWithPhone.innerText.trim();
  let callLinkElem = document.querySelector('#destenation-2-tl-js-get-phone-number-for-origin');
  callLinkElem.setAttribute("href", tl_linkWithPhone.getAttribute('href'));
  callLinkElem.querySelector('span').innerText += " "+ tl_linkWithPhone.getAttribute('href').match(/\d+/g).join('')
  } catch (e){
