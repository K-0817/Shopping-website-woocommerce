...
function tl_selectLocation(elem) {
    let optSlug = elem.getAttribute('attr-slug-value');
    let date = new Date();
    date.setTime(date.getTime() + (370 * 24 * 60 * 60 * 1000));
    let expires = "; expires=" + date.toUTCString();
    document.cookie = "location=" + optSlug + expires + "; path=/";
    location.reload();
}
